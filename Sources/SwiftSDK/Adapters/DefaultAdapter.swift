...
open class DefaultAdapter: NSObject, IResponseAdapter {
    
    public static let shared = DefaultAdapter()
    
    public func adapt(object: Any, toObject: Any) -> Any? {
        return nil
    }
    
    public func adapt<T>(jsonArray: NSArray, toArrayOfType: T) -> Array<T>? {
        return nil
    }
    
    // remove later
    public func adapt(jsonArray: NSArray) -> [UserProperty] {
